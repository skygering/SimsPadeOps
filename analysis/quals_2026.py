...
res_sims_df.to_csv("data/surge_res_runs.csv", index=False)
...
dt_sims_df.to_csv("data/surge_dt_runs.csv", index=False)
...
fW_sims_df.to_csv("data/surge_fW_runs.csv", index=False)
...
len_sims_df.to_csv("data/surge_len_runs.csv", index=False)
...
my_sims_df.to_csv("data/surge_final_runs.csv", index=False)
my_sims_df
