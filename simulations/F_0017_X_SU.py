...
sf = [0.0, 0.4, 0.4, 0.4, 0.4, 0.4]
several_phases = [0.25, 0.5, 0.75, 1.0]
one_phase = [0.5]
sim_phases = [several_phases, several_phases, several_phases, one_phase, several_phases, several_phases]
do_time_budgets = [True, True, False, False, False, True]
do_multi_phase_budgets = [False, False, True, True, True, True]
phase_tol = [0.0, 0.0, 1.0, 1.0, 0.05, 0.05]
phase_movement_iter = itertools.zip_longest(sf, sim_phases, do_time_budgets, do_multi_phase_budgets, phase_tol)
...
varied_header = ["surge_freq", "phases", "do_time_budgets", "do_multi_phase_budgets", "phase_tol", "dt", "filterWidth"]
