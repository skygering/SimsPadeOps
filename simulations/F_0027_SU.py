...
# This set of simulations is to test the sensitivity of my final surge setup to the width of the chanel (Ly/Lz)! 
...
df = pd.read_csv("/scratch/10264/sgering/SimsPadeOps/simulations/F_0027_SU.csv")
...
yLoc = [l / 2 for l in Ly]
zLoc = [l / 2 for l in Ly]
varied_inputs = itertools.zip_longest(CT_prime, Av, f, nx, ny, nz, Lx, Ly, Lz, dt, tstop, n_hrs, filterWidth, useCorrection, yLoc, zLoc)
varied_header = ["cT", "surge_amplitude", "surge_freq", "nx", "ny", "nz", "Lx", "Ly", "Lz", "dt", "tstop", "n_hrs", "filterWidth", "useCorrection", "yLoc", "zLoc"]
