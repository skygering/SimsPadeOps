...
# This set of simulations is to test the sensitivity of my final surge setup to timestep! 
...
df = pd.read_csv("/scratch/10264/sgering/SimsPadeOps/simulations/F_0026_SU.csv")
