# This is my final run of surge parameters for quals!! It relies on the sensitivity testing on 26, 27, 28
import itertools
import jinja_sim_utils as ju
from pathlib import Path
import pandas as pd

# This set of simulations is to test the sensitivity of my final surge setup to the resolution of the chanel (nx/ny)!
